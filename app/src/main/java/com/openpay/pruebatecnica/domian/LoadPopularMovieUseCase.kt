...
class LoadPopularMovieUseCase @Inject constructor(private val repository: Repository) : PagingSource<Int, RatedMovieModel>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, RatedMovieModel> {
        try {
            ...
            val response = repository.loadPopularMovies(pageNumber)
    ...
    private suspend fun loadfromDB(): ArrayList<RatedMovieModel> {
        ...
        val listRatedMovie = repository.getAllPopularMovie()
